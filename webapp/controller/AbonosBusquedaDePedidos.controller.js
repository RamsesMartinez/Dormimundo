sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.AbonosBusquedaDePedidos", {
...
_onRowPress: function (oEvent) {
		...
		return new Promise(function(fnResolve) {
		    ...
		    this.doNavigate("AbonosAbonoDePedidos", oBindingContext, fnResolve, ""
		    );
...
onInit: function () {
        ...
        this.oRouter.getTarget("AbonosBusquedaDePedidos").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
