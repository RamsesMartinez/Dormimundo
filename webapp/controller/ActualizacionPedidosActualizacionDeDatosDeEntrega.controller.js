sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.ActualizacionPedidosActualizacionDeDatosDeEntrega", {
...
_onPageNavButtonPress9: function () {
...
_onButtonPress23: function (oEvent) {
...
_onButtonPress24: function (oEvent) {
...
onInit: function () {
        ...
        this.oRouter.getTarget("ActualizacionPedidosActualizacionDeDatosDeEntrega").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
                ...
                if (sap.ui.Device.system.phone) {
                    ...
                    if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
                        ...
                        oPage.attachNavButtonPress(function () {
                            this.oRouter.navTo("ActualizacionPedidosBusquedaDePedido", {}, true);
                        }.bind(this));
                    }
                }
            }.bind(this)
