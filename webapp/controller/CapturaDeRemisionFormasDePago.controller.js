sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.CapturaDeRemisionFormasDePago", {
...
_onButtonPress7: function (oEvent) {
		...
		return new Promise(function(fnResolve) {
		    ...
		    this.doNavigate("CapturaDeRemisionCierreDeRemision", oBindingContext, fnResolve, ""
		    );
		}.bind(this)).catch(function (err) { if (err !== undefined) { MessageBox.error(err.message); }});
...
onInit: function () {
        ...
        this.oRouter.getTarget("CapturaDeRemisionFormasDePago").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
                ...
                if (sap.ui.Device.system.phone) {
                    ...
                    if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
                        ...
                        oPage.attachNavButtonPress(function () {
                            this.oRouter.navTo("CapturaDeRemisionDatosDeCliente", {}, true);
                        }.bind(this));
                    }
                }
            }.bind(this)
