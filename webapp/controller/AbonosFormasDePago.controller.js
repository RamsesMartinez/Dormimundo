sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.AbonosFormasDePago", {
...
_onPageNavButtonPress7: function () {
...
_onButtonPress20: function (oEvent) {
...
_onButtonPress21: function (oEvent) {
            		
		var oBindingContext = oEvent.getSource().getBindingContext(); 
		
		return new Promise(function(fnResolve) {
		
		    this.doNavigate("AbonosCierreDeAbono", oBindingContext, fnResolve, ""
		    );
		}.bind(this)).catch(function (err) { if (err !== undefined) { MessageBox.error(err.message); }});
...
onInit: function () {
        ...
        this.oRouter.getTarget("AbonosFormasDePago").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
                ...
                if (sap.ui.Device.system.phone) {
                    ...
                    if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
                        ...
                        oPage.attachNavButtonPress(function () {
                            this.oRouter.navTo("AbonosAbonoDePedidos", {}, true);
                        }.bind(this));
                    }
                }
            }.bind(this)
