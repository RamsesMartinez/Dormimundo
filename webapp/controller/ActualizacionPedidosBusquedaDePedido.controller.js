sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.ActualizacionPedidosBusquedaDePedido", {
...
_onRowPress1: function (oEvent) {
		...
		return new Promise(function(fnResolve) {
		    ...
		    this.doNavigate("ActualizacionPedidosActualizacionDeDatosDeEntrega", oBindingContext, fnResolve, ""
		    );
...
onInit: function () {
        ...
        this.oRouter.getTarget("ActualizacionPedidosBusquedaDePedido").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
