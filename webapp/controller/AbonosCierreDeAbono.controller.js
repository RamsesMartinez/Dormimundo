sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.AbonosCierreDeAbono", {
...
_onPageNavButtonPress8: function () {
...
_onButtonPress22: function (oEvent) {
...
onInit: function () {
        ...
        this.oRouter.getTarget("AbonosCierreDeAbono").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
        var oView = this.getView();
                ...
                if (sap.ui.Device.system.phone) {
                    ...
                    if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
                        ...
                        oPage.attachNavButtonPress(function () {
                            this.oRouter.navTo("AbonosFormasDePago", {}, true);
                        }.bind(this));
                    }
                }
            }.bind(this)
