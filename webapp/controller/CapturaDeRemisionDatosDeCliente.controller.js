sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.CapturaDeRemisionDatosDeCliente", {
...
_onPageNavButtonPress1: function () {
...
_onButtonPress5: function (oEvent) {
		...
		return new Promise(function(fnResolve) {
		    ...
		    this.doNavigate("CapturaDeRemisionFormasDePago", oBindingContext, fnResolve, ""
		    );
...
onInit: function () {
        ...
        this.oRouter.getTarget("CapturaDeRemisionDatosDeCliente").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
