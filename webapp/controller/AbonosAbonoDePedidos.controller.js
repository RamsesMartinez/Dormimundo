sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.AbonosAbonoDePedidos", {
...
_onButtonPress7: function (oEvent) {
		...
		return new Promise(function(fnResolve) {
		    ...
		    this.doNavigate("AbonosFormasDePago", oBindingContext, fnResolve, ""
		    );
		}.bind(this)).catch(function (err) { if (err !== undefined) { MessageBox.error(err.message); }});
...
onInit: function () {
        ...
        this.oRouter.getTarget("AbonosAbonoDePedidos").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
                ...
                if (sap.ui.Device.system.phone) {
                    ...
                    if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
                        ...
                        oPage.attachNavButtonPress(function () {
                            this.oRouter.navTo("AbonosBusquedaDePedidos", {}, true);
                        }.bind(this));
                    }
                }
            }.bind(this)
