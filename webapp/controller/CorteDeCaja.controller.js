sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.CorteDeCaja", {
...
onInit: function () {
        ...
        this.oRouter.getTarget("CorteDeCaja").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
                ...
                if (sap.ui.Device.system.phone) {
                    ...
                    if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
                        ...
                        oPage.attachNavButtonPress(function () {
                            this.oRouter.navTo("Dialog10", {}, true);
                        }.bind(this));
                    }
                }
            }.bind(this)
