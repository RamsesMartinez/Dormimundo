sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.dormimundo.controller.CapturaDePedidosCierreDePedido", {
...
_onPageNavButtonPress6: function () {
...
onInit: function () {
        ...
        this.oRouter.getTarget("CapturaDePedidosCierreDePedido").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
        var oView = this.getView();
                ...
                if (sap.ui.Device.system.phone) {
                    ...
                    if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
                        ...
                        oPage.attachNavButtonPress(function () {
                            this.oRouter.navTo("CapturaDePedidosFormasDePago", {}, true);
                        }.bind(this));
                    }
                }
            }.bind(this)
